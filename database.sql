...
-- ============================================
-- QR Code Restaurant Ordering System
-- PostgreSQL Version (Render Compatible)
-- ============================================
...
INSERT INTO menu_items (category_id, name, description, price, is_veg, is_featured) VALUES
(1, 'Paneer Tikka', 'Marinated cottage cheese grilled to perfection', 220.00, TRUE, TRUE),
(2, 'Butter Chicken', 'Creamy tomato-based curry', 350.00, FALSE, TRUE),
(4, 'Chicken Biryani', 'Fragrant basmati rice with chicken', 380.00, FALSE, TRUE),
(5, 'Mango Lassi', 'Refreshing yogurt drink', 120.00, TRUE, TRUE),
(6, 'Gulab Jamun', 'Milk dumplings in syrup', 120.00, TRUE, TRUE),
(7, 'Veg Burger', 'Crispy veg patty burger', 180.00, TRUE, FALSE);
